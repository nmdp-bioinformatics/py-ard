...
* API Spec Improvements by [@pbashyal-nmdp](https://github.com/pbashyal-nmdp) in [#390](https://github.com/nmdp-bioinformatics/py-ard/pull/390)
* feature: Add 1F (First Field) reduction mode by [@pbashyal-nmdp](https://github.com/pbashyal-nmdp) in [#391](https://github.com/nmdp-bioinformatics/py-ard/pull/391)
* feature:  🎩  by [@pbashyal-nmdp](https://github.com/pbashyal-nmdp) in [#392](https://github.com/nmdp-bioinformatics/py-ard/pull/392)
* Bump setuptools from 78.1.1 to 83.0.0 by [@dependabot](https://github.com/dependabot)[bot] in [#393](https://github.com/nmdp-bioinformatics/py-ard/pull/393)


**Full Changelog**: https://github.com/nmdp-bioinformatics/py-ard/compare/2.1.1...2.3.0
